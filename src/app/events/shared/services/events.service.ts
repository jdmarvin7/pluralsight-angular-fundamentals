...
export class EventsService {
  ...
  searchSessions(searchTerm: any): Observable<any> {
...
const events: IEvent[] = [
  {
    ...
    time: '10:00 am',
    price: 599.99,
    imageUrl: 'https://cdn.pixabay.com/photo/2016/11/23/15/48/audience-1853662_960_720.jpg',
    location: {
      address: '1057 DT',
      city: 'London',
      country: 'England'
  ...
  },
  {
    ...
    time: '9:00 am',
    price: 759.00,
    imageUrl: 'https://cdn.pixabay.com/photo/2015/05/29/19/18/crowd-789652_960_720.jpg',
    location: {
